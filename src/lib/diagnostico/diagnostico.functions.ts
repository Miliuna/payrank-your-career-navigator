...
- experiencia_industria_anios (NÚMERO entero): identificá la INDUSTRIA del puesto más reciente del CV (o del aviso/descripción si está en Modo C). Luego sumá los años de los empleos del CV cuya industria sea la misma o muy cercana (ej: banca y fintech; retail y e-commerce; consultoría estratégica y consultoría management). Si hay un recibo con fecha_ingreso_empresa_actual y la empresa actual pertenece a esa industria, usá esa fecha como punto de inicio para el empleo actual en lugar de la fecha del CV si es más precisa. Devolvé un número entero. Si no hay CV o no se puede inferir, null.
- formacion (array): clasificá la formación académica del documento en una o más de estas categorías exactas (usar exactamente estos strings, sin traducir ni modificar): "Secundario completo", "Terciario/Tecnicatura", "Universitario incompleto", "Universitario completo", "Posgrado/Especialización", "Maestría", "Doctorado", "Certificaciones profesionales". Ejemplos: "Licenciado en Administración" → ["Universitario completo"]; "MBA" → ["Maestría"]; "Ingeniero Industrial + MBA" → ["Universitario completo", "Maestría"]; "PMP" → ["Certificaciones profesionales"]. Solo incluir categorías que estén explícitamente respaldadas por el documento.
